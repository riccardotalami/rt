        ...
        <div className='Projects'>
            ...
            <div className="Projects_Sections">
                <div className='each_project_section'>
                    ...
                    <h4>National University of Singapore (NUS), College of Design and Engineering, Department of the Built Environment</h4>
                ...
                <div className='each_project_section'>
                    ...
                    <p>Role: Project Leader</p>
                    <p>In Collaboration With: Prof. <a href="https://www.lboro.ac.uk/departments/abce/staff/jonathan-wright/" target="_blank">Jonathan Wright</a> and Dr. <a href="https://www.engineering.columbia.edu/faculty/bianca-howard" target="_blank">Bianca Howard</a></p>
                </div>

                <div className='each_project_section'>
                    <p className='date'>July 2018 - Current</p>
                    <p className='location'>Singapore</p>
                    <h3>Comparing laboratory and field studies of occupant lighting experience</h3>
                    <h4>Singapore University of Technology and Design (SUTD)</h4>
                    ...
                    <p>Role: Collaborator</p>
                    <p>In Collaboration With: Dr. <a href="https://scholar.google.com/citations?hl=en&user=0nsh9dAAAAAJ&view_op=list_works&sortby=pubdate" target="_blank">J. Alstan Jakubiec</a></p>
                </div>
                ...
                <div className='each_project_section'>
                    ...
                    <h4>University of California, Berkeley (UC Berkeley) - Center for the Built Environment</h4>
                    ...
                    <p>Role: Collaborator</p>
                    <p>In Collaboration With: <a href="https://www.researchgate.net/profile/Fred-Bauman" target="_blank">Fred Bauman</a>, PE</p>
                </div>
                {/* <ul>
                    <li>
