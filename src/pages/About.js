        ...
        <div className='About'>
            ...
            <div className="About_Sections">
                <div className="individual_about_section">
                    <h3>Intro</h3>
                    <p className='intro_paragraph'>Welcome! I am <b>Riccardo Talami, PhD,</b> a Research Project Manager and Research Scientist at the <b>Nanyang Technological University, Singapore (NTU)</b> - Energy Research Institute (ERI@N). </p>
