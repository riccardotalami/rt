...
import RiccardoResume from './../components/Riccardo_Talami_CV_2026.pdf'
        ...
        <div className='Home'>
            ...
            <div className='Home_Title'>
                ...
                <div>
                    ...
                    <div className='interests'>
                        <p>Building Science</p>
                        <p>Building Engineering</p>
                        <p>Building and Urban Performance Simulation</p>
                        <p>Building and Urban Optimization</p>
                        <p>Sustainable and Integrated Building and Urban Design</p>
            ...
            <div className="Home_Sections">
                <div className="individual_home_section">
                    ...
                    <p className='home_sentences'>1)<b>DIGITAL TRANSFORMATION:</b>: developing scalable data-driven methods, workflows, frameworks, software and tools that automate <b> performance-based building and urban optimization processes.</b></p>
                    <p className='home_sentences'>2)<b>TECHNOLOGICAL TRANSFORMATION:</b>: developing technologies and products that accelerate the shift to <b>passive cooling and smart built environments</b>.</p>
