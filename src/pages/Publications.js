        ...
        <div className='Publications'>
            ...
            <div className="Publications_Sections">
                <div className="individual_publication_section">
                    <h3>Journals</h3>
                    <ul>
                        <li>Bonyadi, N., <b> Talami, R.</b>, and Lee. B. 2025. <a href="https://www.sciencedirect.com/science/article/pii/S266612332500042X" target="_blank">Breaking-down Building Design Problems with Decomposition Approaches: A review</a>. <i>Energy and Built Environment, In press</i></li>
