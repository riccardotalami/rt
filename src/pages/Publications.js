        ...
        <div className='Publications'>
            ...
            <div className="Publications_Sections">
                <div className="individual_publication_section">
                    <h3>Journals</h3>
                    <ul>
                        <li>Eshraghi, P., Dehnavi, A. N., Mirdamadi, M., <b> Talami, R.</b>, and Zomorodian Z. S. 2025. <a href="https://doi.org/10.1016/j.enbenv.2024.04.001" target="_blank">An AI-driven framework for rapid and localized optimizations of urban open spaces</a>. <i>Journal of Building Performance Simulation, Under Review</i></li>
