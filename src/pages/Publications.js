        ...
        <div className='Publications'>
            ...
            <div className="Publications_Sections">
                <div className="individual_publication_section">
                    <h3>Journals</h3>
                    <ul>
                        <li>Shah, I., Su, X., Talami, R. and Ghahramani, A. 2024. <a href="https://doi.org/10.1016/j.enbenv.2024.04.001" target="_blank">Enhancing Building Envelopes: Parametric Analysis of Shading Systems for Opaque Facades and Their Comparison with Cool Paints</a>. <i>Energy and Built Environment</i></li>
                        ...
                        <li><b>Talami, R.</b>, Dawoodjee, I. and Ghahramani, A., 2023. <a href="https://doi.org/10.1016/j.enbenv.2023.07.001" target="_blank">Demystifying energy savings from dynamic temperature setpoints under weather and occupancy variability</a>. <i>Energy and Built Environment</i></li>
